...
function Slider() {
  ...
  return (
    <div className="head flex flex-col items-center gap-8 mt-8 px-6">
      <h3 className="font-bold text-2xl sm:text-5xl">
        _______ S E R V I C E S
      </h3>
      <h1 className="text-3xl sm:text-4xl ml-1">
      ...
      <div className="slide-container flex flex-col items-center relative">
        ...
        {/* <img
          src={dis}
          alt="20% off"
          className="absolute top-0 right-0 w-24 h-24 transform rotate-12"
        /> */}
        <img
        ...
        />
        <h2 className="text-3xl font-medium mb-2">{slides[currentSlide].heading}</h2>
